<!-- this will be a place where admin will be able to update their own profile-->
<?php
        ...
        if ($method == "POST") {
            ...
            if (NULL != $user) {
                if (update_user($password, $name, $phone, $user['id'])) {
                    ...
                    echo 'Sucess: successfully updated Profile';
                } else {
                    echo 'unable to Update the profile';
                }
            } else {
                echo 'please try again user does not exist with given email id';
            }
        }
        ?>
